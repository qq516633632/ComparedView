...
public class Paredview extends View{
    ...
    private String top_lable_unit="kg";//顶部文字显示单位
    ...
    private void initView(Context context,AttributeSet attrs){
        if(attrs!=null){
            ...
            fontSize=a.getDimensionPixelSize(R.styleable.Paredview_lable_text_size,50);
            fontColor=a.getColor(R.styleable.Paredview_lable_text_color,Color.GRAY);
            paredheight=a.getDimensionPixelSize(R.styleable.Paredview_pared_hight,10);
